    ...
    <dl class="trade">
      ...
      <dd>
        <ul>
          ...
          <li class="w18pre none"><a href="index.php?act=complain&op=complain_handle_list"><?php echo $lang['dashboard_wel_complain_handle'];?><sub><em id="statistics_complain_handle_list">0</em></sub></a></li>
        </ul>
      </dd>
    </dl>
    <dl class="operation">
...
var work = ['store_joinin','store_expired','store_expire','brand_apply','cashlist','groupbuy_verify_list','points_order','complain_new_list','complain_handle_list', 'product_verify','inform_list','refund','vr_refund','return','cms_article_verify','cms_picture_verify','circle_verify','check_billno','pay_billno'];
