<?php
require_once BASE_PATH.DS."api/payment/wxpayv3/lib/WxPay.Exception.php";
require_once BASE_PATH.DS."api/payment/wxpayv3/lib/WxPay.Config.php";
require_once BASE_PATH.DS."api/payment/wxpayv3/lib/WxPay.Data.php";
//require_once BASE_PATH.DS."api/payment/wxpayv3/unit/log.php";
class WxPayApi
{
	/**
	 * 
